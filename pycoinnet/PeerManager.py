...
class PeerManager:
    ...
    def __init__(self, peer_pipeline, desired_peer_count):
        ...
        self._maintain_task = asyncio.gather(asyncio.gather(*self._outgoing_coroutines), self._maintain_incoming())
